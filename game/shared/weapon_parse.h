...
// SHARED
	...
	char					szAmmoName[MAX_WEAPON_STRING];			// Name for an ammo label in HUD
	...
	int						iAmmoType;
	int						iAmmo2Type;
	bool					m_bCanDrop; // Can a player drop this weapon?
	bool					m_bMeleeWeapon;		// Melee weapons can always "fire" regardless of ammo.
	bool					m_bHideAmmoStock; // Should ths weapon have a stock ammo counter and its background?
	bool					m_bHideAmmoSecondary; // Should ths weapon have a second. ammo counter and its background?
	...
	int						iMuzzleFlashRed;
	int						iMuzzleFlashGreen;
	int						iMuzzleFlashBlue;
	int						iMuzzleFlashRadius;
