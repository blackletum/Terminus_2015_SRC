...
public:
	...
	virtual int				GetMuzzleFlashRed(void) const;
	virtual int				GetMuzzleFlashGreen(void) const;
	virtual int				GetMuzzleFlashBlue(void) const;
	virtual int				GetMuzzleFlashRadius(void) const;

	virtual int				GetCRDamageType(void) const;
	virtual int				GetCRTracer(void) const;
	virtual int				GetCRPlrDmg(void) const;
	virtual int				GetCRNpcDmg(void) const;
	virtual float			GetCRImpulse(void) const;

	bool					HideAmmoStock() const;
	bool					HideAmmoSecondary() const;
