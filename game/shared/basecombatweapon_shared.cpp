...
{
	while (GetActivity() == ACT_VM_RELOAD)
		return false;
...
int CBaseCombatWeapon::GetMuzzleFlashRed() const
{
	return GetWpnData().iMuzzleFlashRed;
}

int CBaseCombatWeapon::GetMuzzleFlashGreen() const
{
	return GetWpnData().iMuzzleFlashGreen;
}

int CBaseCombatWeapon::GetMuzzleFlashBlue() const
{
	return GetWpnData().iMuzzleFlashBlue;
}
int CBaseCombatWeapon::GetMuzzleFlashRadius() const
{
	return GetWpnData().iMuzzleFlashRadius;
}
int CBaseCombatWeapon::GetCRDamageType() const
{
	return GetWpnData().iCRDamageType;
}
int CBaseCombatWeapon::GetCRTracer() const
{
	return GetWpnData().iCRTracer;
}
int CBaseCombatWeapon::GetCRPlrDmg() const
{
	return GetWpnData().iCRPlrDmg;
}
int CBaseCombatWeapon::GetCRNpcDmg() const
{
	return GetWpnData().iCRNpcDmg;
}
float CBaseCombatWeapon::GetCRImpulse() const
{
	return GetWpnData().flCRImpulse;
}
bool CBaseCombatWeapon::HideAmmoStock() const
{
	return GetWpnData().m_bHideAmmoStock;
}
bool CBaseCombatWeapon::HideAmmoSecondary() const
{
	return GetWpnData().m_bHideAmmoSecondary;
}
