...
{
	{ "grenade_rockbb", BRICKBAT_ROCK, 5, "models/weapons/insolence/v_brickbat.mdl", "models/props_junk/Rock001a.mdl" },
	{ "grenade_beerbottle", BRICKBAT_BOTTLE, 5, "models/weapons/insolence/v_bb_bottle.mdl", "models/props_junk/garbage_glassbottle003a.mdl" },
	{ "grenade_crematorhead", BRICKBAT_CREMATORHEAD, 5, "models/weapons/insolence/v_bb_crematorhead.mdl", "models/cremator_headprop.mdl" },
};
...
void CWeaponBrickbat::Precache(void)
{
	...
	UTIL_PrecacheOther("grenade_brickbat");
...
void CWeaponBrickbat::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	...
	case EVENT_WEAPON_THROW:
	{
							   ...
							   Vector launchPos;
							   int iBIndex = pNPC->LookupBone("ValveBiped.Bipe_01_R_Hand");
							   if (iBIndex != -1) {
								   Vector origin;
								   QAngle angles;
...
int CWeaponBrickbat::WeaponRangeAttack1Condition(float flDot, float flDist)
{
	...
	else
	{
		...
		// Get Enemy Position 
		Vector vecTarget = Vector(pEnemy->GetAbsOrigin());
