...
//
//TODO: Our modeller must have decided it's time to take a permanent vacation so now we don't have a working ragdoll.
//See if one of the coders can make this dude vulnerable to conventional weapons and have him explode when killed
//The explosion doesn't have to be anything fancy, just have him use the default explosion effect if it would be more convenient.
// - I would do this myself if I knew how to. This is seriously beyond my already limited coding ability.
// - Keep in mind that although the cguard will be vulnerable to weapons, he will have incredibly high health. Something along the lines of 700-900 hp.
// - Give him a 1 in 4 chance to drop his weapon, if I somehow manage to get the damn weapon code to compile.
//
//=============================================================================//
...
int CNPC_CombineGuard::OnTakeDamage_Alive( const CTakeDamageInfo &inputInfo )
{
