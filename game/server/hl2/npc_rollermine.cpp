...
enum
{
	...
	SCHED_ROLLERMINE_MOVE_TO_LOCATION,
};
...
enum 
{
	...
	TASK_ROLLERMINE_GET_PATH_TO_LOCATION,
};
...
int CNPC_RollerMine::SelectSchedule( void )
{
	...
	if (HasCondition(COND_ROLLERMINE_COMMAND_MOVE))
	{
		ClearCondition(COND_ROLLERMINE_COMMAND_MOVE);
		return SCHED_ROLLERMINE_MOVE_TO_LOCATION;
	}
...
void CNPC_RollerMine::StartTask( const Task_t *pTask )
{
	...
	case TASK_ROLLERMINE_GET_PATH_TO_LOCATION:
	{
...
void CNPC_RollerMine::CommandMoveToLocation(const Vector &vecLocation, CBaseEntity *pCommandEntity)
{
	...
	SetCondition(COND_ROLLERMINE_COMMAND_MOVE);
}
...
AI_BEGIN_CUSTOM_NPC( npc_rollermine, CNPC_RollerMine )
	...
	DECLARE_TASK( TASK_ROLLERMINE_GET_PATH_TO_LOCATION )
	...
	"	Tasks"
	"		TASK_ROLLERMINE_GET_PATH_TO_LOCATION		0"
	"		TASK_ROLLER_ON								0"
	"		TASK_WALK_PATH								0"
	"		TASK_ROLLER_OFF								0"
