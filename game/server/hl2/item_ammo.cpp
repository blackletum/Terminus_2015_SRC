...
public:
	...
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_PISTOL, "Pistol" )|| ITEM_GiveAmmo(pPlayer, SIZE_AMMO_PISTOL, "SmallRound"))
		{
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_PISTOL_LARGE, "Pistol") || ITEM_GiveAmmo(pPlayer, SIZE_LARGE_BOX_SROUNDS, "SmallRound"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_SMG1, "SMG1") || ITEM_GiveAmmo(pPlayer, SIZE_BOX_MROUNDS, "MediumRound" ))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_SMG1_LARGE, "SMG1") || ITEM_GiveAmmo(pPlayer, SIZE_LARGE_BOX_MROUNDS, "MediumRound"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_AR2, "AR2") || ITEM_GiveAmmo(pPlayer, SIZE_BOX_LROUNDS, "LargeRound"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_AR2_LARGE, "AR2") || ITEM_GiveAmmo(pPlayer, SIZE_LARGE_BOX_LROUNDS, "LargeRound"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
