...
ConVar ins_dynamic_lighting_muzzleflash("ins_dynamic_lighting_muzzleflash", "1", FCVAR_ARCHIVE,
"Determines whether a muzzle flash should emit a d.light; only works with player weapons!");
