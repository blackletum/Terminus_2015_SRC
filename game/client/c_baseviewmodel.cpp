...
ConVar ins_weapon_shadowcast_enable("ins_weapon_shadowcast_enable", "0");

ShadowType_t CBaseViewModel::ShadowCastType()
{
	if (ins_weapon_shadowcast_enable.GetBool() == 0)
		return SHADOWS_NONE;
	if (ins_weapon_shadowcast_enable.GetBool() == 1)
