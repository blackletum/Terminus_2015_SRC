...
void CC_DropWeapon(void)
{
	...
	pPlayer->Weapon_DropWeapon();
}

static ConCommand dropprimary("dropprimary", CC_DropPrimary, "dropprimary: Drops the primary weapon of the player.");
static ConCommand dropweapon("dropweapon", CC_DropWeapon, "dropweapon: Drops the players current weapon");
...
void C_BaseHLPlayer::Weapon_DropWeapon(void)
{
	engine->ServerCmd("DropWeapon");
}
